(function(){
  ...
  function carveFlashlight(tctx, sx, sy, ang, opts){
    ...
    const baseHalo = halo * 0.62;
    const haloGrad = tctx.createRadialGradient(sx, sy, 10, sx, sy, baseHalo);
    haloGrad.addColorStop(0, 'rgba(0,0,0,0.96)');
    haloGrad.addColorStop(0.32, 'rgba(0,0,0,0.78)');
    haloGrad.addColorStop(0.72, 'rgba(0,0,0,0.26)');
    haloGrad.addColorStop(1, 'rgba(0,0,0,0)');
    tctx.fillStyle = haloGrad;
    tctx.beginPath();
    tctx.ellipse(sx, sy, baseHalo * 0.72, baseHalo * 0.52, ang, 0, Math.PI * 2);
    tctx.fill();
    ...
    const mouthX = 12;
    const mouthHalfH = nearW * 0.38;
    const midX = length * 0.44;
    const farX = length;
    const midHalfH = farW * 0.34;
    const farHalfH = farW * 0.54;

    const softGrad = tctx.createLinearGradient(0, 0, length, 0);
    softGrad.addColorStop(0, 'rgba(0,0,0,0.72)');
    softGrad.addColorStop(0.22, 'rgba(0,0,0,0.46)');
    softGrad.addColorStop(0.62, 'rgba(0,0,0,0.18)');
    softGrad.addColorStop(1, 'rgba(0,0,0,0)');
    tctx.fillStyle = softGrad;
    tctx.beginPath();
    tctx.moveTo(mouthX, -mouthHalfH);
    tctx.bezierCurveTo(mouthX * 0.28, -mouthHalfH * 1.55, -2, -mouthHalfH * 0.52, 0, 0);
    tctx.bezierCurveTo(-2, mouthHalfH * 0.52, mouthX * 0.28, mouthHalfH * 1.55, mouthX, mouthHalfH);
    tctx.bezierCurveTo(midX * 0.46, farHalfH * 0.72, midX * 0.78, midHalfH * 1.02, farX, farHalfH);
    tctx.lineTo(farX, -farHalfH);
    tctx.bezierCurveTo(midX * 0.78, -midHalfH * 1.02, midX * 0.46, -farHalfH * 0.72, mouthX, -mouthHalfH);
    tctx.closePath();
    tctx.fill();

    const coreGrad = tctx.createLinearGradient(0, 0, length * 0.92, 0);
    coreGrad.addColorStop(0, 'rgba(0,0,0,0.97)');
    coreGrad.addColorStop(0.14, 'rgba(0,0,0,0.86)');
    coreGrad.addColorStop(0.48, 'rgba(0,0,0,0.42)');
    coreGrad.addColorStop(0.84, 'rgba(0,0,0,0.08)');
    coreGrad.addColorStop(1, 'rgba(0,0,0,0)');
    tctx.fillStyle = coreGrad;
    tctx.beginPath();
    tctx.moveTo(mouthX + 3, -mouthHalfH * 0.56);
    tctx.bezierCurveTo(mouthX * 0.46, -mouthHalfH * 0.92, 1, -mouthHalfH * 0.32, 2, 0);
    tctx.bezierCurveTo(1, mouthHalfH * 0.32, mouthX * 0.46, mouthHalfH * 0.92, mouthX + 3, mouthHalfH * 0.56);
    tctx.bezierCurveTo(midX * 0.5, midHalfH * 0.58, farX * 0.82, farHalfH * 0.52, farX, farHalfH * 0.7);
    tctx.lineTo(farX, -farHalfH * 0.7);
    tctx.bezierCurveTo(farX * 0.82, -farHalfH * 0.52, midX * 0.5, -midHalfH * 0.58, mouthX + 3, -mouthHalfH * 0.56);
    tctx.closePath();
    tctx.fill();
